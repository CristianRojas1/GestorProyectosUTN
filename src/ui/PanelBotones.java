...
private VentanaPrincipal ventanaPrincipal;
    ...
    public PanelBotones() {
        initComponents(); // método generado, no modificar

        // Añadimos los listeners aquí, fuera del método generado
        btnTareas.addActionListener(e -> {
            if (ventanaPrincipal != null) ventanaPrincipal.mostrarPanel("Tareas");
        });
        btnUsuarios.addActionListener(e -> {
            if (ventanaPrincipal != null) ventanaPrincipal.mostrarPanel("Usuarios");
        });
        btnProyectos.addActionListener(e -> {
            if (ventanaPrincipal != null) ventanaPrincipal.mostrarPanel("Proyectos");
        });
    }
